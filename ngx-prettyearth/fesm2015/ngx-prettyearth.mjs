...
class NgxPrettyearthService {
    ...
    call() {
        return __awaiter(this, void 0, void 0, function* () {
            const { ok, data, problem, originalError } = yield this.api.get('');
            if (ok) {
                ...
                console.error(problem, originalError === null || originalError === void 0 ? void 0 : originalError.toJSON());
            }
        });
    }
    /**
    ...
    setInterval(timeInterval = 5000) {
        ...
        if (timeInterval >= 1000) {
            ...
            this.subscription = this.timeInterval.subscribe(() => __awaiter(this, void 0, void 0, function* () {
                yield this.call();
            }));
        }
        else {
...
class NgxPrettyearthComponent {
    ...
    getRandomPic() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.prettyearthService.call();
        });
    }
}
